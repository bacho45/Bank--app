...
langSelect.addEventListener("change", () => {
  if (langSelect.value === "EN") {
    ...
    document.querySelector("h1").textContent = "Login";
    emailInput.placeholder = "Email | Tel: Number";
    passwordInput.placeholder = "Password";
    recoverLink.textContent = "Recover Password";
    loginButton.textContent = "Login";
    signUpLink.innerHTML =
      "No account? - <a href='registration.html'>Greate</a>";
  }
  errorText.innerText = "";
...
const validationByLang = () => {
  if (form.classList.contains("English")) {
    ...
    validateInput(emailInput, "No user found", "Welcome!");
    validateInput(passwordInput, "No user found", "Welcome!");
  }
};
